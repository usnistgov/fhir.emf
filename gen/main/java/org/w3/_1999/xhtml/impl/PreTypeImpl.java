...
public class PreTypeImpl extends PreContentImpl implements PreType {
	...
	public void setOnclick(String newOnclick) {
		...
		onclick = newOnclick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONCLICK, oldOnclick, onclick));
	}
	...
	public void setOndblclick(String newOndblclick) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONDBLCLICK, oldOndblclick, ondblclick));
	}
	...
	public void setOnkeydown(String newOnkeydown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONKEYDOWN, oldOnkeydown, onkeydown));
	}
	...
	public void setOnkeypress(String newOnkeypress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONKEYPRESS, oldOnkeypress, onkeypress));
	}
	...
	public void setOnkeyup(String newOnkeyup) {
		...
		onkeyup = newOnkeyup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONKEYUP, oldOnkeyup, onkeyup));
	}
	...
	public void setOnmousedown(String newOnmousedown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONMOUSEDOWN, oldOnmousedown, onmousedown));
	}
	...
	public void setOnmousemove(String newOnmousemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONMOUSEMOVE, oldOnmousemove, onmousemove));
	}
	...
	public void setOnmouseout(String newOnmouseout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONMOUSEOUT, oldOnmouseout, onmouseout));
	}
	...
	public void setOnmouseover(String newOnmouseover) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONMOUSEOVER, oldOnmouseover, onmouseover));
	}
	...
	public void setOnmouseup(String newOnmouseup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__ONMOUSEUP, oldOnmouseup, onmouseup));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XhtmlPackage.PRE_TYPE__LANG1:
				return getLang1();
			case XhtmlPackage.PRE_TYPE__ONCLICK:
				return getOnclick();
			case XhtmlPackage.PRE_TYPE__ONDBLCLICK:
				return getOndblclick();
			case XhtmlPackage.PRE_TYPE__ONKEYDOWN:
				return getOnkeydown();
			case XhtmlPackage.PRE_TYPE__ONKEYPRESS:
				return getOnkeypress();
			case XhtmlPackage.PRE_TYPE__ONKEYUP:
				return getOnkeyup();
			case XhtmlPackage.PRE_TYPE__ONMOUSEDOWN:
				return getOnmousedown();
			case XhtmlPackage.PRE_TYPE__ONMOUSEMOVE:
				return getOnmousemove();
			case XhtmlPackage.PRE_TYPE__ONMOUSEOUT:
				return getOnmouseout();
			case XhtmlPackage.PRE_TYPE__ONMOUSEOVER:
				return getOnmouseover();
			case XhtmlPackage.PRE_TYPE__ONMOUSEUP:
				return getOnmouseup();
