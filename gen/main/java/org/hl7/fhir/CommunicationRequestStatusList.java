...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Communication Request Status List</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getCommunicationRequestStatusList()
 * @model extendedMetaData="name='CommunicationRequestStatus-list'"
 * @generated
 */
public enum CommunicationRequestStatusList implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	IN_PROGRESS(5, "inProgress", "in-progress"),
	...
	/**
	 * An array of all the '<em><b>Communication Request Status List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CommunicationRequestStatusList[] VALUES_ARRAY =
		new CommunicationRequestStatusList[] {
			PROPOSED,
			PLANNED,
			REQUESTED,
			RECEIVED,
	...
	/**
	 * A public read-only list of all the '<em><b>Communication Request Status List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CommunicationRequestStatusList> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Communication Request Status List</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CommunicationRequestStatusList get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CommunicationRequestStatusList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Communication Request Status List</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static CommunicationRequestStatusList getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CommunicationRequestStatusList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Communication Request Status List</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CommunicationRequestStatusList get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CommunicationRequestStatusList(int value, String name, String literal) {
		this.value = value;
		this.name = name;
...
} //CommunicationRequestStatusList
