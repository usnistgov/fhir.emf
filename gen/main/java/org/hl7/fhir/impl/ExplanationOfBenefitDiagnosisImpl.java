 ...
 *   <li>{@link org.hl7.fhir.impl.ExplanationOfBenefitDiagnosisImpl#getDrg <em>Drg</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExplanationOfBenefitDiagnosisImpl extends BackboneElementImpl implements ExplanationOfBenefitDiagnosis {
	...
	public EList<Coding> getType() {
		if (type == null) {
			type = new EObjectContainmentEList<Coding>(Coding.class, this, FhirPackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__TYPE);
		}
		return type;
	}
	...
	public NotificationChain basicSetDrg(Coding newDrg, NotificationChain msgs) {
		...
		drg = newDrg;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__DRG, oldDrg, newDrg);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDrg(Coding newDrg) {
		if (newDrg != drg) {
			NotificationChain msgs = null;
			if (drg != null)
				msgs = ((InternalEObject)drg).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__DRG, null, msgs);
			if (newDrg != null)
				msgs = ((InternalEObject)newDrg).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__DRG, null, msgs);
			msgs = basicSetDrg(newDrg, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__DRG, newDrg, newDrg));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.EXPLANATION_OF_BENEFIT_DIAGNOSIS__DRG:
