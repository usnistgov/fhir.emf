 ...
 *   <li>{@link org.hl7.fhir.impl.ConformanceImpl#getUseContext <em>Use Context</em>}</li>
 ...
 *   <li>{@link org.hl7.fhir.impl.ConformanceImpl#getInstantiates <em>Instantiates</em>}</li>
...
public class ConformanceImpl extends DomainResourceImpl implements Conformance {
	...
	public EList<CodeableConcept> getUseContext() {
		if (useContext == null) {
			useContext = new EObjectContainmentEList<CodeableConcept>(CodeableConcept.class, this, FhirPackage.CONFORMANCE__USE_CONTEXT);
		}
		return useContext;
	}
	...
	public EList<Uri> getInstantiates() {
		if (instantiates == null) {
			instantiates = new EObjectContainmentEList<Uri>(Uri.class, this, FhirPackage.CONFORMANCE__INSTANTIATES);
		}
		return instantiates;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.CONFORMANCE__USE_CONTEXT:
			...
			case FhirPackage.CONFORMANCE__INSTANTIATES:
