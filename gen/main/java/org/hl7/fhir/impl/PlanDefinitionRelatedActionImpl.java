...
import org.hl7.fhir.PlanActionRelationshipAnchor;
 ...
 *   <li>{@link org.hl7.fhir.impl.PlanDefinitionRelatedActionImpl#getAnchor <em>Anchor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlanDefinitionRelatedActionImpl extends BackboneElementImpl implements PlanDefinitionRelatedAction {
	 ...
	 * @ordered
	 */
	protected PlanActionRelationshipType relationship;
	 ...
	 * @ordered
	 */
	protected PlanActionRelationshipAnchor anchor;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRelationship(PlanActionRelationshipType newRelationship, NotificationChain msgs) {
		PlanActionRelationshipType oldRelationship = relationship;
	 ...
	 * @generated
	 */
	public void setRelationship(PlanActionRelationshipType newRelationship) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAnchor(PlanActionRelationshipAnchor newAnchor, NotificationChain msgs) {
		PlanActionRelationshipAnchor oldAnchor = anchor;
		anchor = newAnchor;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ANCHOR, oldAnchor, newAnchor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setAnchor(PlanActionRelationshipAnchor newAnchor) {
		if (newAnchor != anchor) {
			NotificationChain msgs = null;
			if (anchor != null)
				msgs = ((InternalEObject)anchor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ANCHOR, null, msgs);
			if (newAnchor != null)
				msgs = ((InternalEObject)newAnchor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ANCHOR, null, msgs);
			msgs = basicSetAnchor(newAnchor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ANCHOR, newAnchor, newAnchor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ANCHOR:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ACTION_IDENTIFIER:
				...
				return;
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__RELATIONSHIP:
				setRelationship((PlanActionRelationshipType)newValue);
				return;
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__OFFSET_DURATION:
			...
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__OFFSET_RANGE:
				...
				return;
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ANCHOR:
				setAnchor((PlanActionRelationshipAnchor)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ACTION_IDENTIFIER:
				...
				return;
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__RELATIONSHIP:
				setRelationship((PlanActionRelationshipType)null);
				return;
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__OFFSET_DURATION:
			...
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__OFFSET_RANGE:
				...
				return;
			case FhirPackage.PLAN_DEFINITION_RELATED_ACTION__ANCHOR:
				setAnchor((PlanActionRelationshipAnchor)null);
				return;
		}
