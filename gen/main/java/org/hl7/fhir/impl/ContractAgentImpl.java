 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.ContractAgentImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.ContractAgentImpl#getRole <em>Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContractAgentImpl extends BackboneElementImpl implements ContractAgent {
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getContractAgent();
	}
	...
	public NotificationChain basicSetActor(Reference newActor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CONTRACT_AGENT__ACTOR, oldActor, newActor);
	...
	public void setActor(Reference newActor) {
		if (newActor != actor) {
			...
			if (actor != null)
				msgs = ((InternalEObject)actor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CONTRACT_AGENT__ACTOR, null, msgs);
			if (newActor != null)
				msgs = ((InternalEObject)newActor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CONTRACT_AGENT__ACTOR, null, msgs);
			msgs = basicSetActor(newActor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CONTRACT_AGENT__ACTOR, newActor, newActor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.CONTRACT_AGENT__ACTOR:
				return basicSetActor(null, msgs);
			case FhirPackage.CONTRACT_AGENT__ROLE:
