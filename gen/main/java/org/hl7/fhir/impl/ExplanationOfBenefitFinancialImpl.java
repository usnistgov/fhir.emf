...
public class ExplanationOfBenefitFinancialImpl extends BackboneElementImpl implements ExplanationOfBenefitFinancial {
	...
	public NotificationChain basicSetBenefitUnsignedInt(UnsignedInt newBenefitUnsignedInt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_FINANCIAL__BENEFIT_UNSIGNED_INT, oldBenefitUnsignedInt, newBenefitUnsignedInt);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBenefitUnsignedInt(UnsignedInt newBenefitUnsignedInt) {
		if (newBenefitUnsignedInt != benefitUnsignedInt) {
			...
			if (benefitUnsignedInt != null)
				msgs = ((InternalEObject)benefitUnsignedInt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_FINANCIAL__BENEFIT_UNSIGNED_INT, null, msgs);
			if (newBenefitUnsignedInt != null)
				msgs = ((InternalEObject)newBenefitUnsignedInt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_FINANCIAL__BENEFIT_UNSIGNED_INT, null, msgs);
			msgs = basicSetBenefitUnsignedInt(newBenefitUnsignedInt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_FINANCIAL__BENEFIT_UNSIGNED_INT, newBenefitUnsignedInt, newBenefitUnsignedInt));
	}
	...
	public NotificationChain basicSetBenefitUsedUnsignedInt(UnsignedInt newBenefitUsedUnsignedInt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_FINANCIAL__BENEFIT_USED_UNSIGNED_INT, oldBenefitUsedUnsignedInt, newBenefitUsedUnsignedInt);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBenefitUsedUnsignedInt(UnsignedInt newBenefitUsedUnsignedInt) {
		if (newBenefitUsedUnsignedInt != benefitUsedUnsignedInt) {
			...
			if (benefitUsedUnsignedInt != null)
				msgs = ((InternalEObject)benefitUsedUnsignedInt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_FINANCIAL__BENEFIT_USED_UNSIGNED_INT, null, msgs);
			if (newBenefitUsedUnsignedInt != null)
				msgs = ((InternalEObject)newBenefitUsedUnsignedInt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.EXPLANATION_OF_BENEFIT_FINANCIAL__BENEFIT_USED_UNSIGNED_INT, null, msgs);
			msgs = basicSetBenefitUsedUnsignedInt(newBenefitUsedUnsignedInt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.EXPLANATION_OF_BENEFIT_FINANCIAL__BENEFIT_USED_UNSIGNED_INT, newBenefitUsedUnsignedInt, newBenefitUsedUnsignedInt));
	}
